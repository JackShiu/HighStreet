...
const ProductTokenV01 = artifacts.require('ProductTokenV01');
...
contract('integration flow check', function (accounts) {
    ...
    */
    ...
    before('deploy implementation', async function () {
        ...
        this.implementationV01 = await ProductTokenV01.new();
    ...
    beforeEach(async function () {
        ...
        this.beacon = await UpgradeableBeacon.new(this.implementationV01.address, {from: this.owner});
        ...
        // create HighGO token
        const data1 = this.implementationV01.contract
        ...
        this.highGo = new ProductTokenV01(this.highGoAddress);
        await this.highGo.setupVoucher(this.voucherMock.address, 10);
